...
** This File: /bisos/git/bxRepos/bisos-pip/dnsCap/py3/bisos/dnsCap/dnsCap_seed.py
** File True Name: /bisos/git/auth/bxRepos/bisos-pip/dnsCap/py3/bisos/dnsCap/dnsCap_seed.py
...
csInfo['status']  = 'inUse'
csInfo['panel'] = 'dnsCap_seed-Panel.org'
...
seedCSMU = 'dnsCap_seed.cs'

####+BEGIN: b:py3:cs:func/typing :funcName "atexit_plantWithWhich" :funcType "extTyped" :comment "expects dnsCap_seed.cs" :deco "atexit.register"
""" #+begin_org
*  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_ _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_ [[elisp:(outline-show-branches+toggle)][|=]] [[elisp:(bx:orgm:indirectBufOther)][|>]] *[[elisp:(blee:ppmm:org-mode-toggle)][|N]]*  F-T-extTyped [[elisp:(outline-show-subtree+toggle)][||]] /atexit_plantWithWhich/  expects dnsCap_seed.cs deco=atexit.register  [[elisp:(org-cycle)][| ]]
#+end_org """
@atexit.register
